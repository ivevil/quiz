...
const Navigation = () => {
    ...
    return (
        <>
            <nav className="relative px-8 py-2 flex justify-between items-center bg-white">
                ...
                <div className="lg:hidden">
                    <button className="navbar-burger flex items-center text-blue-600 p-3" onClick={() => setOpen(!open)}>
            ...
            <div className={`navbar-menu relative z-50 ${open ? "" : "hidden"}`}>
                <div className="navbar-backdrop fixed inset-0 bg-gray-800 opacity-25" onClick={() => setOpen(!open)}></div>
